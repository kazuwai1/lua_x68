...
MYCFLAGS= -fomit-frame-pointer -fstrength-reduce -finline-functions 
#MYCFLAGS= -fomit-frame-pointer -fstrength-reduce -finline-functions -DLUA_USE_C89 -DLUA_NOBUILTIN -DX68_XC
